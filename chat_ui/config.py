...
class Config:
    ...
    PING_INTERVAL = int(os.getenv("CHAT_PING_INTERVAL", "120"))  # 2 minutes
    CONNECTION_HEALTH_CHECK = bool(
        os.getenv("CHAT_HEALTH_CHECK", "true").lower() == "true")
    HEALTH_CHECK_TIMEOUT = int(os.getenv("CHAT_HEALTH_TIMEOUT", "240"))  # 4 minutes
